...
export const PART2_ANATOMY2 = [
  ...
  },
  {
    ...
    hint: 'התבונן בתרשים: כל שרירי השרוול יושבים מאחור מלבד ה-Subscapularis שיושב מקדימה.',
    options: [
  ...
  },
  {
    ...
    hint: 'התבונן בתרשים: הראש האדום המרכזי שמתחיל בעצם האגן (AIIS).',
    options: [
  ...
  },
  {
    ...
    hint: 'הרדיוס היא העצם שמסתובבת בסופינציה (כף יד כלפי מעלה). איזה שריר מפורסם מסובב אותה ולכן חייב להיאחז בה בתרשים?',
    options: [
  ...
  },
  {
    ...
    hint: 'זיז מקור העורב בקדמת השכמה שמשמש נקודת מוצא לשני שרירי זרוע קדמיים בתרשים.',
    options: [
  ...
  },
  {
    ...
    hint: 'הראש היחיד מבין שלושת ראשי פושט המרפק שחוצה גם את מפרק הכתף ומגיע עד לשכמה בתרשים.',
    options: [
  ...
  },
  {
    ...
    hint: 'התבונן בתרשים ההמסטרינגס: איזה שריר מופיע במדור האחורי של הירך?',
    options: [
  ...
  },
  {
    ...
    hint: 'החלק של שריר הכתף שנמצא מאחור (Posterior) ומושך את המרפקים לאחור בתרשים.',
    options: [
  ...
  },
  {
    ...
    hint: 'הבליטה הקטנה בצד הפנימי-אחורי של עצם הירך (בניגוד לגדולה החיצונית).',
    options: [
  ...
  },
  {
    ...
    hint: 'מתחתיו (ולפעמים דרכו) עובר כבל העצבים העבה ביותר בגוף היורד לכל הרגל.',
    options: [
