...
// --- ספרית תרשימים גרפיים וקטוריים עשירה ומגוונת (לפי חוברות וינגייט) ---
...
// --- מאגר השאלות המלא לפי כל החוברות והנושאים ---
export const ALL_WINGATE_QUESTIONS = [
  ...
  },
  {
    ...
    explanation: 'סה״כ 33 חוליות: 7 צוואריות (לורדוזה), 12 חזיות (קיפוזה), 5 מותניות (לורדוזה), 5 סקרליות מאוחות ו-4 בעצם הזנב.'
  },
  {
    id: 'anat1_9',
    moduleId: 'anat1',
  ...
  },
  {
    ...
    explanation: 'שרירי זוקפי הגב השטחיים מסודרים ב-3 עמודות שריריות המיישרות וזוקפות את עמוד השדרה לאורכו.'
  },
